          ...
          {loading ? (
            ...
            <div className="space-y-6">
                ...
                {acceptedRefactorings.map((refactoring) => (
                  <div
                    ...
                    className={`border rounded-lg p-4 cursor-pointer transition-colors ${
                      selectedRefactorings.includes(refactoring.id)
              ...
              <div className="flex justify-end gap-3 pt-4 border-t border-gray-200 dark:border-slate-700">
                <button
                  onClick={onClose}
                  className="px-6 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 dark:border-slate-600 dark:text-gray-300 dark:hover:bg-slate-700"
                >
                  Cancel
                </button>
                <button

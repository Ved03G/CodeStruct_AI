...
const cardData: BentoCardProps[] = [
    {
        color: "#ffffff",
        title: "Code Analysis",
        description: "Deep analysis of code complexity and structure",
        label: "Analytics",
    },
    {
        color: "#ffffff",
        title: "Project Dashboard",
        description: "Centralized view of all your repositories",
        label: "Overview",
    },
    {
        color: "#ffffff",
        title: "Team Collaboration",
        description: "Share insights and work together on improvements",
        label: "Teamwork",
    },
    {
        color: "#ffffff",
        title: "AI Refactoring",
        description: "Automated code improvements and suggestions",
        label: "Automation",
    },
    {
        color: "#ffffff",
    ...
    },
    {
        color: "#ffffff",
        title: "Code Quality",
        description: "Maintain high standards with quality metrics",
        label: "Quality",
    },
];
...
const BentoCardGrid: React.FC<{
    ...
    <div
        className="bento-section grid gap-2 p-3 w-full min-h-[600px] select-none relative"
    ...
    return (
        <>
          ...
          .card--border-glow:hover {
            box-shadow: 0 4px 20px rgba(229, 231, 235, 0.4), 0 0 30px rgba(${glowColor}, 0.2);
          }
          ...
          .particle-container:hover {
            box-shadow: 0 4px 20px rgba(229, 231, 235, 0.2), 0 0 30px rgba(${glowColor}, 0.2);
          }
